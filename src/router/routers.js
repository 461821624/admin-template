  ...
  },
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            component: () => import('@/view/media-capital/media-capital-management/media-pool.vue')
          },
          {
            path: 'media_audit',
            name: 'media_audit',
      ...
      },
      {
        ...
        children: [
          {
            path: 'distribution_node',
            name: 'distribution_node',
            meta: {
              icon: 'md-funnel',
              title: '三级'
            },
            component: () => import('@/view/media-capital/distribution-management/distribution-node.vue')
          },
          {
